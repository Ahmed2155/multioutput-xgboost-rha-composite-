...
df = pd.read_csv("composite_data._2csv", encoding='latin1')
...
loo = LeaveOneOut()
model = KNeighborsRegressor(n_neighbors=3)  # You can try 2, 3, 4...
...
plt.scatter(actual, predicted, color='purple', label='Predicted Points')
...
plt.title("KNN: Actual vs Predicted Wear Rate (LOOCV)")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
